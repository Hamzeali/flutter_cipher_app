class CaesarAlgo {
  static String encryption(word, shift, alphabets) {
    ...
    for (var i = 0; i < phrase.length; i++) {
      ...
      if (position != -1) {
        var positionAfterEncryption = (position + shift) % 26;
  ...
  static String decryption(word, shift, alphabets) {
    String phrase = word.toLowerCase();
    var decryptedWord = '';
    var position = -1;
    var nonAlphabet = ' '.codeUnitAt(0);
    ...
    for (var i = 0; i < phrase.length; i++) {
      ...
      if (position != -1) {
        var positionAfterDecryption = (position + 26 - shift) % 26;
